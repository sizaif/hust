...
{
    var imgJson=[];
    if("undefined"!==eval("typeof w"+p+"imgJsons"))eval("imgJson = w"+p+"imgJsons");
    else {
...
window.jQuery || document.write('<script type="text/javascript" src="'+EXTEND_PATH+'libs/jquery.min.js"><\/script>');d
ocument.write('<script type="text/javascript" src="'+EXTEND_PATH+'libs/jquery.sudy.js"><\/script>');